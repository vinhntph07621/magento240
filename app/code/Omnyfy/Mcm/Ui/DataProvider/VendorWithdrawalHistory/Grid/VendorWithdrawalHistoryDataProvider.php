...
namespace Omnyfy\Mcm\Ui\DataProvider\VendorWithdrawalHistory\Grid;
...
class VendorWithdrawalHistoryDataProvider extends \Magento\Framework\View\Element\UiComponent\DataProvider\DataProvider {
    ...
    public function getData() {
        ...
        foreach ($collection as $fee) {
            $fee->setData('withdrawal_amount_currency', ($fee['withdrawal_amount']) ? $this->currency($fee['withdrawal_amount'], true, false) : '');
        }
