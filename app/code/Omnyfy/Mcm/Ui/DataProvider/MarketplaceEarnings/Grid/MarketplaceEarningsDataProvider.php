...
class MarketplaceEarningsDataProvider extends \Magento\Framework\View\Element\UiComponent\DataProvider\DataProvider {
    ...
    public function getData() {
        ...
        foreach ($collection as $payout) {
            ...
            $payout->setData('mcm_base_transaction_fee_incl_tax', $this->currency($payout['mcm_base_transaction_fee_incl_tax']));
            $payout->setData('mcm_transaction_fee_surcharge', $this->currency($payout['mcm_transaction_fee_surcharge']));
            ...
            $payout->setData('mo_total_earning_amount', $this->currency($payout['mo_total_earning_amount']));
        }
