...
class VendorWithdrawalHistory extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb {
    ...
    protected function _construct() {
        $this->_init('omnyfy_mcm_vendor_bank_withdrawals_history', 'id');
    }
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object) {
        ...
        if ($object->isObjectNew() && !$object->getCreatedAt()) {
             $object->setWithdrawalDate($gmtDate);
