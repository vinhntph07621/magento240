...
namespace Omnyfy\Mcm\Model\VendorPayoutInvoice;

use Magento\Framework\Model\AbstractModel;

class VendorPayoutInvoiceOrder extends AbstractModel {
    ...
    protected function _construct() {
        $this->_init('Omnyfy\Mcm\Model\ResourceModel\VendorPayoutInvoice\VendorPayoutInvoiceOrder');
    }
}
