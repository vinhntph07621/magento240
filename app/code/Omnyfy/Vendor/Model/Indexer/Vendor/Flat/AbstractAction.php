...
abstract class AbstractAction
{
     ...
     * @param \Omnyfy\Vendor\Model\VendorType $vendorType
     ...
     *
     * @param array|int $ids
     * @return \Omnyfy\Vendor\Model\Indexer\Vendor\Flat\AbstractAction
     */
    ...
    protected function _cleanOnFailure(array $tablesList, $storeId)
    {
        ...
        $tableName = $this->_getTemporaryTableName($this->_vendorIndexerHelper->getFlatTableName($storeId));
    ...
    protected function _isFlatTableExists($storeId)
    {
        if (!isset($this->_flatTablesExist[$storeId])) {
            $tableName = $this->_vendorIndexerHelper->getFlatTableName($storeId);
