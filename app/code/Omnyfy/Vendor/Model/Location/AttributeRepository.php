...
class AttributeRepository implements \Omnyfy\Vendor\Api\LocationAttributeRepositoryInterface
{
    ...
    public function __construct(
        ...
        \Omnyfy\Vendor\Model\Resource\Location\Attribute $attributeResource,
        \Omnyfy\Vendor\Helper\Vendor $locationHelper
    ) {
        $this->eavAttributeRepository = $eavAttributeRepository;
        $this->eavConfig = $eavConfig;
        $this->searchCriteriaBuilder = $searchCriteriaBuilder;
        $this->attributeResource = $attributeResource;
        $this->loctionHelper = $locationHelper;
    ...
    public function save(\Omnyfy\Vendor\Api\Data\LocationAttributeInterface $attribute)
    {
        if ($attribute->getAttributeId()) {
            ...
            $attribute->setSourceModel(
                $this->locationHelper->getAttributeSourceModelByInputType($attribute->getFrontendInput())
            );
            $attribute->setBackendModel(
                $this->locationHelper->getAttributeBackendModelByInputType($attribute->getFrontendInput())
            );
            $attribute->setEntityTypeId(
                $this->eavConfig
                    ->getEntityType(\Omnyfy\Vendor\Api\Data\LocationAttributeInterface::ENTITY_TYPE_CODE)
                    ->getId()
            );
    ...
    public function delete(\Omnyfy\Vendor\Api\Data\LocationAttributeInterface $attribute)
    {
