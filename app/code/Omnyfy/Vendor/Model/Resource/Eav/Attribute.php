...
namespace Omnyfy\Vendor\Model\Resource\Eav;
...
class Attribute extends \Magento\Eav\Model\Entity\Attribute implements
    \Omnyfy\Vendor\Api\Data\LocationAttributeInterface, \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface
{
    ...
    protected $_eventPrefix = 'omnyfy_vendor_location_attribute';
    ...
    public function __construct(
        ...
        \Omnyfy\Vendor\Model\Indexer\Location\Eav\Processor $indexerEavProcessor,
        \Omnyfy\Vendor\Helper\Location\Flat\Indexer $locationFlatIndexerHelper,
        ...
        array $data = [])
    {
        ...
        $this->_locationFlatIndexerHelper = $locationFlatIndexerHelper;
    ...
    {
        $this->_init('Omnyfy\Vendor\Model\Resource\Location\Attribute');
    }
    ...
    protected function _isEnabledInFlat()
    {
        return $this->getData('backend_type') == 'static'
            || $this->_locationFlatIndexerHelper->isAddFilterableAttributes()
    ...
    public function __sleep()
    {
        ...
        return array_diff(
            parent::__sleep(),
            ['_indexerEavProcessor', '_locationFlatIndexerProcessor', '_locationFlatIndexerHelper', 'attrLockValidator']
        );
    }
    ...
    public function __wakeup()
    {
        ...
        $this->_indexerEavProcessor = $objectManager->get(\Omnyfy\Vendor\Model\Indexer\Location\Flat\Processor::class);
        $this->_locationFlatIndexerProcessor = $objectManager->get(
            \Omnyfy\Vendor\Model\Indexer\Location\Eav\Processor::class
        );
        $this->_locationFlatIndexerHelper = $objectManager->get(\Omnyfy\Vendor\Helper\Location\Flat\Indexer::class);
