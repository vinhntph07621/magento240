...
class Gallery extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
     ...
     */
    const GALLERY_TABLE = 'omnyfy_vendor_entity_media_gallery';

    const GALLERY_VALUE_TABLE = 'omnyfy_vendor_entity_media_gallery_value';

    const GALLERY_VALUE_TO_ENTITY_TABLE = 'omnyfy_vendor_entity_media_gallery_value_to_entity';
