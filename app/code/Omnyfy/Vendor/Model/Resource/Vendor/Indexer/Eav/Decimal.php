...
class Decimal extends AbstractEav
{
    ...
    {
        $this->_init('omnyfy_vendor_index_eav_decimal', 'entity_id');
    }
    ...
    protected function _prepareIndex($entityIds = null, $attributeId = null)
    {
        ...
        $select = $connection->select()->from(
            ['pdd' => $this->getTable('omnyfy_vendor_vendor_entity_decimal')],
            []
        )->join(
            ...
            ['pds' => $this->getTable('omnyfy_vendor_vendor_entity_decimal')],
            sprintf(
        ...
        $this->_eventManager->dispatch(
            'prepare_omnyfy_vendor_index_select',
            [
                'select' => $select,
    ...
    {
        return $this->tableStrategy->getTableName('omnyfy_vendor_index_eav_decimal');
    }
}
