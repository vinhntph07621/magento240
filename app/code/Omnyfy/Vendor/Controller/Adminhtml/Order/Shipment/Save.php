...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $locationId = $this->getRequest()->getParam('location_id', 0);
        $vendorId = $this->getRequest()->getParam('vendor_id', 0);
        if (empty($locationId) || empty($vendorId)) {
            $this->messageManager->addError(__('Location missing. Please specify a location and try again.'));
            return $resultRedirect->setPath('sales/order/index');
        }
