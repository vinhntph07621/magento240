...
class Validate extends \Omnyfy\Vendor\Controller\Adminhtml\Vendor\Attribute
{
    ...
    public function execute()
    {
        ...
        $attribute = $this->_objectManager->create(
            \Omnyfy\Vendor\Model\Resource\Vendor\Eav\Attribute::class
        )->loadByCode(
            $this->_entityTypeId,
            $attributeCode
        );
        ...
        if ($attribute->getId() && !$attributeId) {
            ...
            $response->setVendorAttribute($attribute->toArray());
        }
