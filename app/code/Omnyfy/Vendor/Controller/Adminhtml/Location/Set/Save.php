...
class Save extends \Omnyfy\Vendor\Controller\Adminhtml\Location\Set
{
    /**
    ...
    public function execute()
    {
        ...
        if ($isNewSet) {
            if ($this->getRequest()->getPost('return_session_messages_only')) {
                ...
                if ($hasError) {
                    $resultRedirect->setPath('omnyfy_vendor/*/add');
                } else {
                    $resultRedirect->setPath('omnyfy_vendor/*/edit', ['id' => $model->getId()]);
                }
            ...
            if ($hasError) {
                ...
                $response['error'] = 0;
                $response['url'] = $this->getUrl('omnyfy_vendor/*/');
            }
