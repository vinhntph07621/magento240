 ...
 * Time: 16:28
 */
namespace Omnyfy\Vendor\Block\Adminhtml\Vendor\Attribute\Set;

use Omnyfy\Vendor\Model\Entity\Vendor\Attribute\Group\AttributeMapperInterface;
...
class Main extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @var \Omnyfy\Vendor\Model\Entity\Vendor\Attribute\Group\AttributeMapperInterface
     */
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild('group_tree', \Omnyfy\Vendor\Block\Adminhtml\Vendor\Attribute\Set\Main\Tree\Group::class);

        $this->addChild('edit_set_form', \Omnyfy\Vendor\Block\Adminhtml\Vendor\Attribute\Set\Main\Formset::class);
    ...
    {
        return $this->getUrl('omnyfy_vendor/vendor_set/save', ['id' => $this->_getSetId()]);
    }
    ...
    {
        return $this->getUrl('omnyfy_vendor/vendor_group/save', ['id' => $this->_getSetId()]);
    }
    ...
    protected function _toHtml()
    {
        $this->_eventManager->dispatch(
            'adminhtml_vendor_attribute_set_main_html_before',
            ['block' => $this]
        );
