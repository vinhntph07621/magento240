...
use Omnyfy\Vendor\Model\Entity\Vendor\Attribute;
...
class Front extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->_eventManager->dispatch('vendor_attribute_form_build_front_tab', ['form' => $form]);
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label' => __('Visible on Pages on Storefront'),
                'title' => __('Visible on Pages on Storefront'),
                'values' => $yesnoSource
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'used_in_form',
                'label' => __('Used in registration form.'),
                'title' => __('Used in registration form.'),
                'values' => $yesnoSource
            ]
        );
