 ...
 * Time: 16:58
 */
namespace Omnyfy\Vendor\Block\Adminhtml\Location\Attribute\Set;

use Omnyfy\Vendor\Model\Entity\Location\Attribute\Group\AttributeMapperInterface;
...
class Main extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Omnyfy_Vendor::vendor/attribute/set/main.phtml';
    ...
    /**
     * @var \Omnyfy\Vendor\Model\Entity\Location\Attribute\Group\AttributeMapperInterface
     */
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild('group_tree', \Omnyfy\Vendor\Block\Adminhtml\Location\Attribute\Set\Main\Tree\Group::class);

        $this->addChild('edit_set_form', \Omnyfy\Vendor\Block\Adminhtml\Location\Attribute\Set\Main\Formset::class);
    ...
    {
        return $this->getUrl('omnyfy_vendor/location_set/save', ['id' => $this->_getSetId()]);
    }
    ...
    {
        return $this->getUrl('omnyfy_vendor/location_group/save', ['id' => $this->_getSetId()]);
    }
    ...
    protected function _toHtml()
    {
        $this->_eventManager->dispatch(
            'adminhtml_location_attribute_set_main_html_before',
            ['block' => $this]
        );
