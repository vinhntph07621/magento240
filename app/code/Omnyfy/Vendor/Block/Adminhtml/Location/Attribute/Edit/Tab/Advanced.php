...
class Advanced extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        Yesno $yesNo,
        Data $eavData,
        array $disableScopeChangeList = ['name'],
        array $data = []
    ) {
        $this->_yesNo = $yesNo;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __('Select "Yes" to add this attribute to the list of column options in the vendor grid.'),
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __('Select "Yes" to add this attribute to the list of filter options in the vendor grid.'),
            ]
        );
        ...
        $this->_eventManager->dispatch('location_attribute_form_build', ['form' => $form]);
