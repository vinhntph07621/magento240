 ...
 * Time: 14:41
 */
namespace Omnyfy\Vendor\Helper\Vendor\Flat;
...
class Indexer extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     */
    const XML_NODE_ATTRIBUTE_NODES = 'omnyfy_vendor/vendor/flat/attribute_groups';
    ...
    /**
     * List of indexes uses in flat vendor table
     *
     * @var null|array
     */
    protected $_indexes;
    ...
    /**
     * Retrieve Vendor flat columns array in old format (used before MMDB support)
     *
     * @return array
     */
     ...
     * @var array
     */
    protected $_systemAttributes = ['name', 'status'];
    ...
    /**
     * @var \Omnyfy\Vendor\Model\Vendor\Attribute\Config
     */
    ...
    /**
     * @var \Omnyfy\Vendor\Model\Resource\Vendor\Config
     */
    ...
    public function __construct(
        ...
        \Omnyfy\Vendor\Model\Vendor\Attribute\Config $attributeConfig,
    ...
    {
        return \Omnyfy\Vendor\Model\Vendor::ENTITY;
    }
    ...
    public function getAttributeCodes()
    {
        if ($this->_attributeCodes === null) {
            ...
            $whereCondition = [
                ...
                $connection->quoteInto('additional_table.used_in_listing = ?', 1),
    ...
    {
        return sprintf('%s_%s', $this->getTable('omnyfy_vendor_vendor_flat'), $storeId);
    }
    ...
    {
        $connection = $this->_resource->getConnection();
        $existentTables = $connection->getTables($connection->getTableName('omnyfy_vendor_vendor_flat_%'));
        $this->_changelog->setViewId('omnyfy_vendor_vendor_flat');
