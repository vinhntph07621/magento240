...
class Tools extends \Magento\Framework\View\Element\Template
{
    ...
    public function getLogoUrl($toolIcon)
    {
        if (empty($toolIcon)) {
            return false;
        }
        return $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . $toolIcon;
    }
