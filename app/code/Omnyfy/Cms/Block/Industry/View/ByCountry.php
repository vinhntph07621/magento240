...
class ByCountry extends \Magento\Framework\View\Element\Template
{
	...
	public function getChildCategories(){
		return $this->categoryFactory->create()->load($this->getIndustry()->getByCountry())->getChildrenIds();
	}
	...
	public function getContentVisible(){
		$industryId = $this->getIndustry()->getByCountry();
