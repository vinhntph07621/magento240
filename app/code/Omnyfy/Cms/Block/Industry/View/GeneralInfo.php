 ...
 * Time: 3:30 PM
 */
namespace Omnyfy\Cms\Block\Industry\View;

use Magento\Framework\View\Element\Template;

class GeneralInfo extends \Magento\Framework\View\Element\Template
{
	...
	public function getChildCategories(){
		return $this->categoryFactory->create()->load($this->getIndustry()->getIndustryCategory())->getChildrenIds();
	}
