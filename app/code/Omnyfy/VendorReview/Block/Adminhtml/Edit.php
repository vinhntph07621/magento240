    ...
    protected function _construct()
    {
        ...
        if ($prevId !== false) {
            $this->addButton(
                ...
                [
                    'label' => __('Previous'),
                    'onclick' => 'setLocation(\'' . $this->getUrl('vendorreview/*/*', ['id' => $prevId]) . '\')'
                ],
                3,
                10
            );
        ...
        if ($nextId !== false) {
            ...
            $this->addButton(
                ...
                [
                    'label' => __('Next'),
                    'onclick' => 'setLocation(\'' . $this->getUrl('vendorreview/*/*', ['id' => $nextId]) . '\')'
                ],
                3,
                105
            );
        ...
        if ($this->getRequest()->getParam('vendorId', false)) {
            $this->buttonList->update(
                ...
                'setLocation(\'' . $this->getUrl(
                    'catalog/vendor/edit',
                    ['id' => $this->getRequest()->getParam('vendorId', false)]
                ) . '\')'
            );
        }
