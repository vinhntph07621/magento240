...
class Form extends Template {
    ...
    public function __construct(
		...
		\Omnyfy\VendorSignUp\Helper\Data $helperData,
    ...
    {
        return $this->directoryBlock->getCountryId();
    }
    /**
    ...
    public function getFormAction() {
        return $this->getUrl('omnyfy_vendorsignup/index/save', ['_secure' => true]);
    }
    ...
    public function getEmailCheckAction() {
        return $this->getUrl('omnyfy_vendorsignup/index/checkaccount', ['_secure' => true]);
    }
	...
	public function countrySelector(){
		...
		foreach($this->getCountryCodes() as $code => $country){
			$countryName = ucwords(strtolower($country["name"])); 
			$countries .= "<option value='".$country["code"]."'>".$code." - ".$countryName." (+".$country["code"].")</option>";
		}
	...
	public function getGoogleKey(){
		return $this->_helper->getGoogleReCaptchaKey();
	}
