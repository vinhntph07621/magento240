...
define([
    ...
    /**
     * Vendor gallery widget
     */
    $.widget('mage.vendorGallery', {
        options: {
        ...
        _addItem: function (event, imageData) {
            var count = this.element.find(this.options.imageSelector).length,
                element,
                imgElement;
            if (typeof imageData.size == "undefined") {
                return;
            }
            imageData = $.extend({
                'file_id': imageData.entity_id ? imageData.entity_id : Math.random().toString(33).substr(2, 18),
    ...
    // Extension for mage.vendorGallery - Add advanced settings block
    $.widget('mage.vendorGallery', $.mage.vendorGallery, {
        options: {
