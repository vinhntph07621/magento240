...
define([
    ...
    /**
     */
    $.widget('mage.newVendorVideoDialog', {
        ...
        _replaceImage: function (oldFile, newFile, imageData) {
            ...
            suff = 'album[media_gallery][images]' + fc;
            ...
            $(oldValIdElem).attr({
                type: 'hidden',
                name: 'album[media_gallery][images][' + newImageId + '][save_data_from]'
            }).val(key);
        ...
        _addVideoClass: function (url) {
            ...
            console.log(this._gallery.find('img[src="' + url + '"]'));
        ...
        findElementId: function (file) {
            ...
            return $(elem).attr('name').replace('album[media_gallery][images][', '').replace('][file]', '');
        },
    ...
    return $.mage.newVendorVideoDialog;
});
